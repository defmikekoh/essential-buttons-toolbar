...
const defaultVariables = {
    ...
    iconTheme: 'heroIcons',
    hideMethod: 'disable',
    pageUpDownScrollType: 'smooth',
    pageUpDownScrollOverlap: 80,
    pageUpDownScrollOverlapLongpress: 60,
    homepageBg: 'none',
    ...
    topSiteFontSize: 11,
    topSitesGridGap: 10,
    topSitesContainerWidth: 80,
    topSitesContainerHeight: 65,
